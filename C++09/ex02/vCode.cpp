...
void PmergeMe::vectorStart(std::vector<int> intVec, int i)
{
...
void PmergeMe::vectorInsertion(std::vector<int> lowVec, std::vector<int> highVec)
{
	_finalVec = highVec;
	size_t a = 0;
...
void PmergeMe::vectorBetweenJacobs(std::vector<int> lowVec, std::vector<int> highVec, int a, int b)
{
...
void PmergeMe::vectorInsertLast(std::vector<int> lowVec)
{
